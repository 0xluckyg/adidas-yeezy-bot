...
class SneakerBot:
	def __init__(self, master): # Initialize Window
		...
		# Item Entry
		URL = 'http://www.adidas.com/us/superstar-primeknit-shoes/S82241.html?forceSelSize=S82241_590'
	...
	def Login(self): # Login Function
		...
		# Select size
		select = browser.find_element_by_class_name('size-select')
